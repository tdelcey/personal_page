...
::: {.article-hero-image}
![This graph is one of the main results of the bibliometric analysis. Nodes represent articles citing Fama (1970), and edges represent shared references. The graph is colored by clusters of articles that share similar references. It shows how Fama (1970) disseminates in economics and various other fields, such as law, management, and marketing.](picture.jpg)
:::
...
::: {.article-links}
[HAL](https://hal.science/hal-05121997/) · [Google Scholar](https://scholar.google.com/scholar?q=The%20Dissemination%20of%20Fama%20%281970%29%3A%20A%20Bibliometric%20Analysis) · [Shiny app](https://019c241f-91f4-a63b-1097-ed53083ffbbc.share.connect.posit.cloud) · [Code](https://github.com/tdelcey/research/tree/main/fama_1970)
:::
